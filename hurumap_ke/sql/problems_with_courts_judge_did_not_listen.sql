...
ALTER TABLE IF EXISTS ONLY public.problems_with_courts_judge_did_not_listen DROP CONSTRAINT IF EXISTS pk_problems_with_courts_judge_did_not_listen;
DROP TABLE IF EXISTS public.problems_with_courts_judge_did_not_listen;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- Name: problems_with_courts_judge_did_not_listen; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.problems_with_courts_judge_did_not_listen (
    geo_level character varying(15) NOT NULL,
    geo_code character varying(10) NOT NULL,
    geo_version character varying(100) DEFAULT ''::character varying NOT NULL,
    problems_with_courts_judge_did_not_listen character varying(128) NOT NULL,
    total integer
);


--
-- Data for Name: problems_with_courts_judge_did_not_listen; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.problems_with_courts_judge_did_not_listen (geo_level, geo_code, geo_version, problems_with_courts_judge_did_not_listen, total) FROM stdin;
...
county	22	2009	Once or Twice	2
county	3	2009	Once or Twice	1
...
county	47	2009	Once or Twice	6
county	32	2009	Once or Twice	2
county	29	2009	Once or Twice	3
county	18	2009	Once or Twice	1
county	19	2009	Once or Twice	1
county	13	2009	Once or Twice	1
county	26	2009	Once or Twice	1
county	27	2009	Once or Twice	1
\.


--
-- Name: problems_with_courts_judge_did_not_listen pk_problems_with_courts_judge_did_not_listen; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.problems_with_courts_judge_did_not_listen
    ADD CONSTRAINT pk_problems_with_courts_judge_did_not_listen PRIMARY KEY (geo_level, geo_code, geo_version, problems_with_courts_judge_did_not_listen);

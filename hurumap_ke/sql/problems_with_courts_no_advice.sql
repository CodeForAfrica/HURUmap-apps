...
ALTER TABLE IF EXISTS ONLY public.problems_with_courts_no_advice DROP CONSTRAINT IF EXISTS pk_problems_with_courts_no_advice;
DROP TABLE IF EXISTS public.problems_with_courts_no_advice;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- Name: problems_with_courts_no_advice; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.problems_with_courts_no_advice (
    geo_level character varying(15) NOT NULL,
    geo_code character varying(10) NOT NULL,
    geo_version character varying(100) DEFAULT ''::character varying NOT NULL,
    problems_with_courts_no_advice character varying(128) NOT NULL,
    total integer
);


--
-- Data for Name: problems_with_courts_no_advice; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.problems_with_courts_no_advice (geo_level, geo_code, geo_version, problems_with_courts_no_advice, total) FROM stdin;
county	36	2009	A Few times	2
county	14	2009	A Few times	3
county	43	2009	A Few times	1
county	34	2009	A Few times	3
county	15	2009	A Few times	3
county	16	2009	A Few times	2
county	17	2009	A Few times	3
...
county	12	2009	Never	2
county	1	2009	Never	2
county	21	2009	Never	1
county	47	2009	Never	13
...
county	15	2009	Once or Twice	5
county	2	2009	Once or Twice	1
county	16	2009	Once or Twice	5
county	17	2009	Once or Twice	2
county	12	2009	Once or Twice	9
county	44	2009	Once or Twice	1
county	1	2009	Once or Twice	1
county	21	2009	Once or Twice	2
county	47	2009	Once or Twice	14
county	32	2009	Once or Twice	7
...
county	26	2009	Once or Twice	2
county	23	2009	Once or Twice	1
county	27	2009	Once or Twice	1
county	24	2009	Once or Twice	2
\.


--
-- Name: problems_with_courts_no_advice pk_problems_with_courts_no_advice; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.problems_with_courts_no_advice
    ADD CONSTRAINT pk_problems_with_courts_no_advice PRIMARY KEY (geo_level, geo_code, geo_version, problems_with_courts_no_advice);

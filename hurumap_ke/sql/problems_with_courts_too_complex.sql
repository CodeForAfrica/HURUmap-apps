...
ALTER TABLE IF EXISTS ONLY public.problems_with_courts_too_complex DROP CONSTRAINT IF EXISTS pk_problems_with_courts_too_complex;
DROP TABLE IF EXISTS public.problems_with_courts_too_complex;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- Name: problems_with_courts_too_complex; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.problems_with_courts_too_complex (
    geo_level character varying(15) NOT NULL,
    geo_code character varying(10) NOT NULL,
    geo_version character varying(100) DEFAULT ''::character varying NOT NULL,
    problems_with_courts_too_complex character varying(128) NOT NULL,
    total integer
);


--
-- Data for Name: problems_with_courts_too_complex; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.problems_with_courts_too_complex (geo_level, geo_code, geo_version, problems_with_courts_too_complex, total) FROM stdin;
county	30	2009	A Few times	1
county	36	2009	A Few times	2
county	14	2009	A Few times	4
...
county	16	2009	A Few times	7
county	17	2009	A Few times	1
county	12	2009	A Few times	6
...
county	36	2009	Once or Twice	1
county	39	2009	Once or Twice	5
county	40	2009	Once or Twice	2
county	14	2009	Once or Twice	2
county	43	2009	Once or Twice	1
county	34	2009	Once or Twice	6
...
--
-- Name: problems_with_courts_too_complex pk_problems_with_courts_too_complex; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.problems_with_courts_too_complex
    ADD CONSTRAINT pk_problems_with_courts_too_complex PRIMARY KEY (geo_level, geo_code, geo_version, problems_with_courts_too_complex);

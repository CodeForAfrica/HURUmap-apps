...
class PromisesDetailView(BaseGeographyDetailView):
...
class WajibishaGeographyDetailView(BaseGeographyDetailView):
    adjust_slugs = True
    default_geo_version = None
    ...
    def get_template_names(self):
        return ['profile/profile_detail_%s.html' % self.profile_name,
                'profile/profile_detail_promises.html']

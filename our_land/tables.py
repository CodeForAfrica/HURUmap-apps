...
FieldTable(['class'], id='landsalesdistributiontransaction', universe='Agricultural Land Sales', year='2016')
FieldTable(['class'], id='landsalesdistributionlowestprice', universe='Agricultural Land Sales', year='2016', value_type='Float')
FieldTable(['class'], id='landsalesdistributionhighestprice', universe='Agricultural Land Sales', year='2016', value_type='Float')
FieldTable(['class'], id='landsalesdistributionaverageprice', universe='Agricultural Land Sales', year='2016', value_type='Float')
FieldTable(['class'], id='landsalesdistributionpricetrends', universe='Agricultural Land Sales', year='2016', value_type='Float')
FieldTable(['class'], id='landsalesdistributionaveragetrends', universe='Agricultural Land Sales', year='2016', value_type='Float')
FieldTable(['class'], id='landsalesdistributionaveragepricejuly', universe='Agricultural Land Sales', year='2016', value_type='Float')
FieldTable(['class'], id='landsalesdistributionhectares', universe='Agricultural Land Sales', year='2016')

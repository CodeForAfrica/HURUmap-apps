...
CREATE TABLE public.causesofdeathoverfive (
...
COPY public.causesofdeathoverfive (geo_level, geo_code, "causes of death over five", total, geo_version) FROM stdin;
...
--
-- Name: causesofdeathoverfive pk_causesofdeathoverfive; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.causesofdeathoverfive

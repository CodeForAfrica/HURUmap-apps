...
CREATE TABLE public.towndistrictdistributionavgprice (
    ...
    town_name_ap character varying(128) NOT NULL,
    class_ap character varying(128) NOT NULL,
    total integer
);
...
--
COPY public.towndistrictdistributionavgprice (geo_level, geo_code, geo_version, town_name_ap, class_ap, total) FROM stdin;

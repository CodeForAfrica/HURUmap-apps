...
CREATE TABLE public.landsalesdistributiontransaction (
    ...
    class_distribution_transaction character varying(128) NOT NULL,
    total integer
);
...
COPY public.landsalesdistributiontransaction (geo_level, geo_code, geo_version, class_distribution_transaction, total) FROM stdin;

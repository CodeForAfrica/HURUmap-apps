...
DROP INDEX IF EXISTS pesayetu.wazimap_geography_version_01953818_like;
DROP INDEX IF EXISTS pesayetu.wazimap_geography_name_36b79089_like;
DROP INDEX IF EXISTS pesayetu.wazimap_geography_long_name_9b8409f5_like;
DROP INDEX IF EXISTS pesayetu.wazimap_geography_b068931c;
DROP INDEX IF EXISTS pesayetu.wazimap_geography_2fc6351a;
DROP INDEX IF EXISTS pesayetu.wazimap_geography_2af72f10;
ALTER TABLE IF EXISTS ONLY pesayetu.wazimap_geography DROP CONSTRAINT IF EXISTS wazimap_geography_pkey;
ALTER TABLE IF EXISTS ONLY pesayetu.wazimap_geography DROP CONSTRAINT IF EXISTS wazimap_geography_geo_level_bbe3c9fc_uniq;
ALTER TABLE IF EXISTS pesayetu.wazimap_geography ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS pesayetu.wazimap_geography_id_seq;
DROP TABLE IF EXISTS pesayetu.wazimap_geography;
SET search_path = public, pg_catalog;
...
CREATE TABLE pesayetu.wazimap_geography (
    id integer NOT NULL,
...
CREATE SEQUENCE pesayetu.wazimap_geography_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE pesayetu.wazimap_geography_id_seq OWNED BY wazimap_geography.id;
...
ALTER TABLE ONLY pesayetu.wazimap_geography ALTER COLUMN id SET DEFAULT nextval('wazimap_geography_id_seq'::regclass);
...
COPY pesayetu.wazimap_geography (id, geo_level, geo_code, name, square_kms, parent_level, parent_code, long_name, version) FROM stdin;

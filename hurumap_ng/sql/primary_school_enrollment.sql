...
ALTER TABLE IF EXISTS ONLY public.primary_school_enrollment DROP CONSTRAINT IF EXISTS primary_school_enrollment_pkey;
...
COPY public.primary_school_enrollment (geo_level, geo_code, geo_version, gender, year, total) FROM stdin;
...
--
-- Name: primary_school_enrollment primary_school_enrollment_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.primary_school_enrollment
    ADD CONSTRAINT primary_school_enrollment_pkey PRIMARY KEY (geo_level, geo_code, geo_version, gender, year);

...
ALTER TABLE IF EXISTS ONLY public.suspects_prosecuted DROP CONSTRAINT IF EXISTS suspects_prosecuted_pkey;
DROP TABLE IF EXISTS public.suspects_prosecuted;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- Name: suspects_prosecuted; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.suspects_prosecuted (
...
--
-- Data for Name: suspects_prosecuted; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.suspects_prosecuted (geo_level, geo_code, geo_version, year, total) FROM stdin;
state	1	2016	2012	50
state	1	2016	2013	6
state	1	2016	2014	15
state	1	2016	2015	45
state	1	2016	2016	47
...
state	3	2016	2014	32
state	3	2016	2015	30
state	3	2016	2016	18
state	4	2016	2012	108
state	4	2016	2013	9
state	4	2016	2014	38
state	4	2016	2015	22
state	4	2016	2016	50
state	5	2016	2012	57
...
state	6	2016	2015	30
state	6	2016	2016	20
state	7	2016	2012	75
state	7	2016	2013	12
...
state	20	2016	2016	343
state	21	2016	2012	113
state	21	2016	2013	79
...
state	35	2016	2015	32
state	35	2016	2016	53
state	36	2016	2012	12
state	36	2016	2013	7
state	36	2016	2014	10
state	36	2016	2015	0
state	36	2016	2016	19
state	37	2016	2012	23
state	37	2016	2013	42
state	37	2016	2014	36
state	37	2016	2015	41
state	37	2016	2016	56
country	NG	2016	2012	2292
country	NG	2016	2013	1772
country	NG	2016	2014	1981
country	NG	2016	2015	1633
country	NG	2016	2016	2194
\.


--
-- Name: suspects_prosecuted suspects_prosecuted_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.suspects_prosecuted
    ADD CONSTRAINT suspects_prosecuted_pkey PRIMARY KEY (geo_level, geo_code, geo_version, year);

...
COPY public.arrested_suspects (geo_level, geo_code, gender, year, total) FROM stdin;
...
ALTER TABLE ONLY public.arrested_suspects
    ADD CONSTRAINT arrested_suspects_pkey PRIMARY KEY (geo_level, geo_code, gender, year);

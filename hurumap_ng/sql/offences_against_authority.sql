...
ALTER TABLE IF EXISTS ONLY public.offences_against_authority DROP CONSTRAINT IF EXISTS offences_against_authority_pkey;
DROP TABLE IF EXISTS public.offences_against_authority;
SET default_tablespace = '';

SET default_with_oids = false;

--
-- Name: offences_against_authority; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.offences_against_authority (
...
--
-- Data for Name: offences_against_authority; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.offences_against_authority (geo_level, geo_code, geo_version, crime, total) FROM stdin;
...
--
-- Name: offences_against_authority offences_against_authority_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.offences_against_authority
    ADD CONSTRAINT offences_against_authority_pkey PRIMARY KEY (geo_level, geo_code, geo_version, crime);

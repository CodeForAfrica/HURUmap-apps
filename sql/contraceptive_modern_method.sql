...
ALTER TABLE IF EXISTS ONLY public.contraceptive_modern_method DROP CONSTRAINT IF EXISTS contraceptive_modern_method_pkey;
...
--
-- Name: contraceptive_modern_method; Type: TABLE; Schema: public; Owner: -; Tablespace:
--
...
\.
--
-- Name: contraceptive_modern_method_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace:
--
